...
var RENDERER = {
    ...
    init : function(){
        ...
        this.resizeCanvas(); // 初始化时设置 Canvas 的宽度和高度
        this.setup();
        this.bindEvent();
        this.render();
    },
    ...
    watchWindowSize: function () {
        this.clearTimer();
        this.tmpWidth = this.$window.innerWidth; // 使用 innerWidth 和 innerHeight 获取窗口大小
        this.tmpHeight = this.$window.innerHeight;
        this.watchIds.push(setTimeout(this.jdugeToStopResize, this.WATCH_INTERVAL));
        this.resizeCanvas(); // 调用 resizeCanvas 方法重新设置 Canvas 的宽度和高度
    },
    clearTimer : function(){
